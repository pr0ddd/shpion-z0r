...
import { Box, Typography, List, ListItem, ListItemText, ListItemAvatar, Avatar, Skeleton, Slider, Stack, Dialog, DialogTitle, DialogContent, TextField, Button } from '@mui/material';
import { useParticipants, useIsSpeaking, useIsMuted, useTracks, AudioTrack, useRoomContext } from '@livekit/components-react';
...
export const ServerMembers = () => {
  ...
  return (
    <Box sx={{ 
      ...
      <Box sx={{ mt: 'auto', pt: 2 }}>
        <VoiceControlBar onDisconnect={() => { /* disconnect handled in bar */ }} />
      </Box>
      {selectedServer && (
          <InviteDialog 
