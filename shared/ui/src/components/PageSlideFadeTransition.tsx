...
import './PageSlideFadeTransition.css';

interface PageSlideFadeTransitionProps {
  server: Server;
}
...
export const PageSlideFadeTransition: React.FC<PageSlideFadeTransitionProps> = ({ server }) => {
  return (
    <motion.div
