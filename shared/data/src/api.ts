...
export const serverAPI = {
  ...
  createServer: (name: string) => http.post<ApiResponse<Server>>('/servers', { name }).then(res => res.data),
...
export const dataClient = { http, authAPI, serverAPI, inviteAPI, messageAPI, livekitAPI };
