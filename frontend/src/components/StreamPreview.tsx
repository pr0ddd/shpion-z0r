...
import { VideoTrack, TrackRefContext, TrackReference, useParticipants } from '@livekit/components-react';
...
export const StreamPreview: React.FC<StreamPreviewProps> = ({ trackRef }) => {
